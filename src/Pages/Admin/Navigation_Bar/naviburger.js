...
function NavBar() {
  ...
  return (
    <React.Fragment>
      <GlobalStyles styles={{ ul: { margin: 0, padding: 0, listStyle: 'none' } }} />
      <CssBaseline />
      <AppBar style={{ background: lightBlue }} position="fixed" color="default" elevation={0} sx={{ borderBottom: (theme) => `1px solid ${theme.palette.divider}` }}>
        <Toolbar sx={{ flexWrap: 'wrap' }}>
          <Typography marginLeft="50px">
            <Avatar alt="QAirline" src={Image} sx={{ width: 250, height: 60 }} variant="rounded" />
          </Typography>
          <Typography marginLeft="15px" variant="h8" color="inherit" noWrap sx={{ flexGrow: 1, color: "#5465FF" }} style={{}}>
            Logged in as an Admin
          </Typography>
          <nav>
            <Button
              ...
              sx={{ my: 1, mx: 1.5 }}
              style={{ color: 'inherit', textDecoration: 'inherit', ':hover': { color: 'purple' } }}
              // onClick={() => { /* Không sử dụng navigate ở đây nữa */ }}
            >
              Home
            </Button>
            ...
            >
              {/* <MenuItem onClick={handleOpen1}>Passengers on a given Flight</MenuItem> */}
              <MenuItem>Passengers on a given Flight</MenuItem>
              <Modal
                // aria-labelledby="transition-modal-title"
                // aria-describedby="transition-modal-description"
                // open={open1}
              ...
              {/* <MenuItem onClick={handleOpen2}>No. of Passengers given a Date Range</MenuItem> */}
              <MenuItem>No. of Passengers given a Date Range</MenuItem>
              <Modal
                // aria-labelledby="transition-modal-title"
                // aria-describedby="transition-modal-description"
                // open={open2}
