...
import Grid from '@mui/material/Grid';
import Box from '@mui/material/Box';
import Image1 from './airline1.jpg';
import Image2 from './airline4.jpg';
import Image3 from './airline5.jpg';
import Button from '@mui/material/Button';
import { useState, useEffect } from 'react';
      ...
      >
        ...
        <Grid container>
          <Grid item md={6}>
            ...
            >
              <Typography fontSize={100} component="h0" variant="h2" color="inherit" gutterBottom>
                <center>Q Airline</center>
              </Typography>
              <Typography fontSize={50} marginTop={'10px'} color="inherit">
                <center>Your Journey - Our Priority </center>
              </Typography>
            </Box>
          </Grid>
        </Grid>
